  ...
  return (
    <article className="rounded-xl bg-zinc-800/80 border border-zinc-700/50 overflow-hidden">
      ...
      {(item.image || item.imagePlaceholder !== false) && (
        <div className="h-28 bg-zinc-600/50 flex items-center justify-center border-b border-zinc-700/50 overflow-hidden">
          {item.image ? (
      ...
      <div className="p-4 flex gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="text-zinc-100 font-medium text-sm line-clamp-2">{item.title || item.url}</h3>
